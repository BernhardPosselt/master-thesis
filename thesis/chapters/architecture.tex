...
ISO 42010 definiert, wie erwähnt, weder Architektursichten- noch Architekturmodelle, stellt jedoch einen Rahmen für diese bereit. \cite[S. 138]{basiswissen}

Ein Beispiel für ein Modell ist zB. Kruchtens 4+1 Sichtenmodell, welches folgende Sichten beinhaltet \cite{kruch}:

\begin{itemize}
  \item Logical View: Logische Sicht auf das System, welche sich mit der Funktionalität des Systems beschäftigt
  \item Development View: Beschreibt die Aufteilung des Systems in Module und Bibliotheken aus der Sicht des Programmierers
  \item Process View: Beschäftigt sich mit dem Laufzeitverhalten des Systems, wie zB. Parallelität und Kommunikation. Hier werden vor allem nicht funktionale Anforderungen schlagend
  \item Physical View: Regelt und beschreibt die Verteilung der Komponenten auf physische Systeme,
  \item Scenarios: Beschreibt die Usecases eines Systems, um die Architekturentscheidungen zu validieren
\end{itemize}


Es gibt noch viele weitere Sichtenmodelle wie zB. das Zachman Framework \cite[S. 282]{zachman}, welches eine Aufteilung in Kontext-, Geschäfts-, System-, Technologie-, Integrations- und Laufzeitsicht vornimmt. Die Gemeinsamkeit aller Sichtenmodelle ist jedoch der Versuch, durch unterschiedliche Sichtweisen einen besseren Überblick über das Zielsystem zu erlangen und diese Übersicht für die jeweiligen .
