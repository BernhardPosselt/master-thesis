...
\begin{figure}[!htbp]
    ...
    \caption{Class Diagramm der Daten und deren Beziehungen}
\end{figure}

\subsection{Wer und Warum (Akteure und Anforderungen)}
b
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=0.5]{uml/usecase.png}
    \caption{Usecase Diagramm der Anforderungen und Akteure}
\end{figure}
