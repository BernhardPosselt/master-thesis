...
Deswegen wird nun aufgrund der in der Anforderungsanalyse ermittelten Schadenstabelle eine Aufspaltung in mehrere Systeme nach folgendem Algorithmus vorgenommen, welcher in Abbildung \ref{fig:actordecision} dar gestellt wird.

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{uml/actordecision.png}
    \caption{Aufspaltung in mehrere Systeme auf Basis der Schadenskosten}
    \label{fig:actordecision}
\end{figure}

Folgende stark Abbildung \ref{}
