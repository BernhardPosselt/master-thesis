...
Deswegen wird nun anhand der in der Anforderungsanalyse ermittelten Schadenstabelle des unerlaubten Datenzugriffs eine Aufspaltung in mehrere Systeme vorgenommen, falls die Schadenskosten die eines neuen Systemes überschreiten.

Im Falle des Beispielprojektes wird zB. für die stark vereinfachten Aktivitäts Diagramme in Abbildung \ref{fig:actorarch} ermittelt, dass die möglichen Schadenskosten im Falle, dass der Anwärter (Applicant) Zugriff auf die Prüfungsantworten (Answer) bekommt, die eines eigenen Systems überschreiten. Deswegen wird der Usecase aus dem System in eigenes System entkoppelt.
...
Für den Fall, dass bei der Aufspaltung zu viele Systeme entstanden sind, werden nun in einem weiteren Schritt diverse Teilsysteme wieder zusammen gelegt, solange deren Schadenskosten nicht die Systemkosten überschreiten.
