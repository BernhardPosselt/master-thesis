...
\subsection{Wie kann ich Fehlerkosten minimieren}
...
Wichtig: Security ist eine funktionale Anforderung, aber
...
Erklären wie man auf Matrix kommt (Aktivitätsdiagramm)
...
\subsection{Man darf Ehrfahrungswerte nicht vernachlässigen}
