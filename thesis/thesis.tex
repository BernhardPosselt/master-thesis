...
\place{Wien}
\kurzfassung{\input{./chapters/kurzfassung}}
\schlagworte{Softwarearchitektur, Softwarearchitekturbewertung, Softwarequalität}
\outline{\input{./chapters/abstract}}
\keywords{software architecture, software architecture review methods, software quality}
...
\input{./chapters/processcreation}
\input{./chapters/processrequirements}
\input{./chapters/processarchitecture}
